...
let GetFlightStatus = async (Airline, flight, timestamp) => {
  ...
  random_number = 2;
  console.log("random status code: ", STATUS_CODE_LIST[random_number]);
    ...
    */
    ...
    for(let idx = 0; idx < 3; idx++) {
      ...
      try {
        ...
        let key_2 = await flightSuretyApp.methods.submitOracleResponse(oracleIndexes[idx], Airline, flight, timestamp, STATUS_CODE_LIST[random_number]).send({
          from: accounts[a],
          //"value": fee,
          gas: 6666666,
          gasPrice: 100000000000
